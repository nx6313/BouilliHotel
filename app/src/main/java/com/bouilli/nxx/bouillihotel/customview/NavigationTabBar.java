...
/**
 * Created by 18230 on 2016/10/31.
 */
    ...
    protected void onDraw(final Canvas canvas) {
        ...
        if (mBitmap == null || mBitmap.isRecycled()) {
            mBitmap = Bitmap.createBitmap(
                    ((int) mBounds.width())>0?((int) mBounds.width()):10, mBadgedHeight>0?mBadgedHeight:10, Bitmap.Config.ARGB_8888
            );
        ...
        for (int i = 0; i < mModels.size(); i++) {
            ...
            if (mIsHorizontalOrientation) {
                ...
                leftTitleOffset = mBounds.width() * 0.5F;
                topTitleOffset =
                        (mModelSize * i) + ((mModelSize - iconMarginTitleHeight) * 0.5F);
            }
