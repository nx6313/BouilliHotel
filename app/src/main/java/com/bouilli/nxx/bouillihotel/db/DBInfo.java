...
public class DBInfo {
    ...
    public static class CreateTable {
        ...
        public static final String CREATE_PRINT_TABLE = "create table if not exists "
                ...
                "record_id varchar(100), table_id varchar(100), table_no varchar(80), print_context text, current_state integer, create_date varchar(100), print_date varchar(100), print_count integer, tip_count integer); ";
        ...
        public static final String CREATE_BILL_TABLE = "create table if not exists "
                ...
                "bill_id varchar(100), table_no varchar(80), print_context text, current_state integer, tip_count integer); ";
